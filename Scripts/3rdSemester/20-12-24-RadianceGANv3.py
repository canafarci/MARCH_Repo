...
def summarize_performance(step, g_model, d_model, gan_model, dataset, n_samples=3):
    ...
    #save plot to file
    filename1 = "__ganResults\\radiancev3\\plot_%06d.png" % (step + 1)
    pyplot.savefig(filename1)
    pyplot.close()
    #save the generator model
    filename2 = "_models\\_radiancev3\\model%06d.h5" % (step + 1)
    g_model.save(filename2)
    #save the disc model
    filename3 = "_models\\_radiancev3\\disc.h5"
    d_model.save(filename3)
    #save the gan model
    filename4 = "_models\\_radiancev3\\gan.h5"
...
# load image data
dataset = load_real_samples("_datasets\\_radiancev3\\rad_256.npz")
