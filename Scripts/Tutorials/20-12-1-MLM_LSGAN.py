...
def summarize_performance(step, g_model, latent_dim, n_samples=100):
	...
	# save plot to file
	filename1 = '__ganResults\\LSGAN\\generated_plot_%06d.png' % (step+1)
	pyplot.savefig(filename1)
	pyplot.close()
	# save the generator model
	filename2 = '_models\\_LSGAN\\model_%06d.h5' % (step+1)
...
def plot_history(d1_hist, d2_hist, g_hist):
	...
	pyplot.legend()
	filename = '__ganResults\\LSGAN\\plot_line_plot_loss.png'
