...
_URL = 'http://efrosgans.eecs.berkeley.edu/pix2pix/datasets/maps.tar.gz'
...
filename = "_datasets\\_googlemaps\\maps_256.npz"
savez_compressed(filename, src_images, tar_images)
print("Saved dataset: ", filename) """

#load dataset
data = load("_datasets\\_googlemaps\\maps_256.npz")
...
def summarize_performance(step, g_model, dataset, n_samples=3):
    ...
    #save plot to file
    filename1 = "__ganResults\\pix2pixgooglemaps\\plot_%06d.png" % (step + 1)
    pyplot.savefig(filename1)
    pyplot.close()
    #save the generator model
    filename2 = "_models\\_Pix2Pix_GoogleMaps\\model%06d.h5"
...
# load image data
dataset = load_real_samples("_datasets\\_googlemaps\\maps_256.npz")
