...
PATH = "C:\_Thesis\VirtualEnv\_datasets\_CFDGANv1"
print (PATH)
...
# dataset paths
src_path = PATH +"/isometric/"
tar_path = PATH +"/analysis/"
# load dataset
[src_images, tar_images] = load_images(src_path, tar_path)
print("Loaded: ", src_images.shape, tar_images.shape)
# save as compressed numpy array
filename = "_datasets\\_CFDGANv1\\cfd_256.npz"
...
"""
#load dataset
data = load("_datasets\\_CFDGANv1\\cfd_256.npz")
...
def summarize_performance(step, g_model, dataset, n_samples=3):
    ...
    #save plot to file
    filename1 = "__ganResults\\CFDGANv1\\plot_%06d.png" % (step + 1)
    pyplot.savefig(filename1)
    pyplot.close()
    #save the generator model
    filename2 = "_models\\_CFDGANv1\\model%06d.h5" % (step + 1)
...
# load image data
dataset = load_real_samples("_datasets\\_CFDGANv1\\cfd_256.npz")
